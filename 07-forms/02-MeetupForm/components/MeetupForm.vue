  ...
  <form class="meetup-form" @submit.prevent="submitHandler">
    <div class="meetup-form__content">
      ...
      <meetup-agenda-item-form
        ...
        @update:agendaItem="localMeetup.agenda.splice(index, 1, $event)"
    ...
    <div class="meetup-form__aside">
      <div class="meetup-form__aside-stick">
        ...
        <ui-button variant="secondary" block class="meetup-form__aside-button" data-test="cancel" @click="cancelHandler">Отмена</ui-button>
  ...
  methods: {
    addAgendaItem() {
      ...
      if (this.localMeetup.agenda.length) {
        newAgenda.startsAt = this.localMeetup.agenda[this.localMeetup.agenda.length - 1].endsAt;
      }
